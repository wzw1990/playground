...
import cc.ikey.playground.agentbuddy.classloader.IndyPluginClassLoader;
...
public class IndyPluginClassLoaderFactory {
    ...
    private static final AgentLogger LOGGER = AgentLogger.getLogger(IndyPluginClassLoaderFactory.class);
    ...
    private static Map<Collection<String>, WeakReference<ClassLoader>> getOrCreateInjectedClasses(ClassLoader targetClassLoader) {
        return alreadyInjected.computeIfAbsent(targetClassLoader, k -> new HashMap<>());
    }
