...
public final class WeakConcurrent {
    ...
    public interface WeakMapBuilder<K, V> {
        ...
        WeakMapBuilder<K, V> withDefaultValueSupplier(WeakMap.DefaultValueSupplier<K, V> defaultValueSupplier);
    ...
    public interface ThreadLocalBuilder<T> {
        ...
        ThreadLocalBuilder<T> withDefaultValueSupplier(WeakMap.DefaultValueSupplier<Thread, T> defaultValueSupplier);
